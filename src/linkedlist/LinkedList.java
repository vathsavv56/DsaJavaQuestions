    ...
    public class LinkedList {
        ...
        public Node sortListArray(Node head){
        ...
        public Node getMiddleM1(Node head){
            Node slow = head;
            Node fast = head.next;
    ...
    //        }
            ...
            Node sorted = ls.removeLoop(ls.head);
